...
#ekstrak year digit dari kolom order_date
df['order_year'] = df['order_date'].dt.year

#tahun terakhir pada data frame
...
with mx_profit_percentage:
    curr_profit_percentage = data.loc[data['order_year'] == CURR_YEAR, 'profit_percentage'].values[0]
    prev_profit_percentage = data.loc[data['order_year'] == PREV_YEAR, 'profit_percentage'].values[0]
    profit_percentage_diff_pct = 100.0 * (curr_profit_percentage - prev_profit_percentage) / prev_profit_percentage
    st.metric("profit_percentage", value=f'{curr_profit_percentage:.2f}%', delta=f'{profit_percentage_diff_pct:.2f}%')
